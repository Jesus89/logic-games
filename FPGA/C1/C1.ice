{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "a2cd916d-c636-4894-9b98-5df641cf035c",
          "type": "basic.output",
          "data": {
            "name": "A",
            "pins": [
        ...
        {
          "id": "bd6b3d85-343a-4109-a3b9-e5763ef3237b",
          "type": "basic.input",
          "data": {
            "name": "A",
            "pins": [
        ...
        {
          "id": "36f1890f-379a-4eea-9686-4bed5af10cbe",
          "type": "basic.output",
          "data": {
            "name": "S",
            "pins": [
        ...
        {
          "id": "b7c47769-0a42-4cc8-8d21-893202974721",
          "type": "basic.input",
          "data": {
            "name": "B",
            "pins": [
        ...
        {
          "id": "8ff01b9b-ef9c-434c-ad88-d678f5e78ee6",
          "type": "basic.output",
          "data": {
            "name": "B",
            "pins": [
        ...
        {
          "id": "8be6ff58-49f3-4d78-875b-5e5ab4de92b0",
        ...
        {
          "id": "225c2f4b-f578-4df3-80d5-7ce7f4c8bc6a",
          "type": "20a1db0a310fc90e729971eb2f687b93980e728a",
          "position": {
            "x": 432,
            "y": 320
        ...
        {
          "id": "456a0d2e-7868-49c0-9fcf-aa005f6ae04d",
        ...
        {
          "id": "34ab9ebf-acaf-4b45-a50e-1c1e61a390f9",
        ...
        {
          "id": "8cc0d0e6-b788-4baa-a30d-8697cd6c7e0c",
          "type": "32200dc0915d45d6ec035bcec61c8472f0cc7b88",
          "position": {
            "x": 264,
            "y": 280
      ...
      "wires": [
        {
          "source": {
            "block": "bd6b3d85-343a-4109-a3b9-e5763ef3237b",
            "port": "out"
          },
          "target": {
            "block": "8be6ff58-49f3-4d78-875b-5e5ab4de92b0",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          }
        },
        {
          "source": {
            "block": "b7c47769-0a42-4cc8-8d21-893202974721",
            "port": "out"
          },
          "target": {
            "block": "225c2f4b-f578-4df3-80d5-7ce7f4c8bc6a",
        ...
        },
        {
          ...
          "target": {
            "block": "34ab9ebf-acaf-4b45-a50e-1c1e61a390f9",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          }
        },
        {
        ...
        },
        {
          ...
          "target": {
            "block": "456a0d2e-7868-49c0-9fcf-aa005f6ae04d",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          }
        },
        {
        ...
        },
        {
          ...
          "target": {
            "block": "8cc0d0e6-b788-4baa-a30d-8697cd6c7e0c",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "36f1890f-379a-4eea-9686-4bed5af10cbe",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "a2cd916d-c636-4894-9b98-5df641cf035c",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "8ff01b9b-ef9c-434c-ad88-d678f5e78ee6",
            "port": "in"
          },
          "vertices": []
        }
